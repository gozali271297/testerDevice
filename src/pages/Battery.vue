...
<q-page class="container">
  <cp-head title="Battery" icon="battery_charging_full" :chrome="true" :firefox="true"></cp-head>
    ...
    <div class="col-12">
      <q-list bordered separator>
        <q-item clickable>
          ...
          <q-item-section>
            <q-item-label>Charging</q-item-label>
          </q-item-section>
        ...
        <q-item clickable >
          ...
          <q-item-section>
            <q-item-label>Charging Time</q-item-label>
          </q-item-section>
        ...
        <q-item clickable >
          ...
          <q-item-section>
            <q-item-label>Discharging Time</q-item-label>
          </q-item-section>
